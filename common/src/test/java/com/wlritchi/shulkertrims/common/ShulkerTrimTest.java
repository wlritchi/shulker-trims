  ...
  class ConstructionTests {
    ...
    void throwsWhenPatternIsNull() {
      NullPointerException exception =
          assertThrows(NullPointerException.class, () -> new ShulkerTrim(null, "minecraft:gold"));
    ...
    void throwsWhenMaterialIsNull() {
      NullPointerException exception =
          assertThrows(NullPointerException.class, () -> new ShulkerTrim("minecraft:coast", null));
