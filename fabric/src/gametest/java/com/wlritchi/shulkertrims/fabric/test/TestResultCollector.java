...
/**
 * Collects test results across multiple test classes to enable running all tests before failing.
 * This allows the Fabric Client GameTest framework to run all entrypoints and produce a complete
 * summary at the end.
 *
