...
public class ShulkerTrimRecipe implements SmithingRecipe {
  ...
  /**
   * Extract pattern name from template item ID. Example: "wild_armor_trim_smithing_template" ->
   * "wild"
   */
  ...
  public IngredientPlacement getIngredientPlacement() {
    if (this.ingredientPlacement == null) {
      this.ingredientPlacement =
          IngredientPlacement.forShapeless(List.of(template, base, addition));
    }
  ...
  public static class Serializer implements RecipeSerializer<ShulkerTrimRecipe> {
    private static final MapCodec<ShulkerTrimRecipe> CODEC =
